...
'	<img src="../common/images/PacktPub-logo.jpg" alt="Документация OpenStack" width="109" height="44"/></a>'+
''+
'	<h1>'+HeaderName+'</h1>'+
...
'		<a href="http://onreader.mdl.ru/CephCookbook/content/Ch08.html">Книга рецептов Ceph	</a>'+
'		(<a onclick="_gaq.push([\'_trackEvent\', \'Header\', \'pdfDownload\', \'click\', 1]);" alt="Загрузите pdf изображений" class="pdficon" href="http://www.packtpub.com/sites/default/files/downloads/LearningDockerNetworking_ColorImages.pdf">'+
'		<img src="../common/images/pdf.png"/></a>) &nbsp; '+
'		<a href="https://www.packtpub.com/networking-and-servers/learning-docker-networking">Купить оригинал</a>'+
'       &nbsp; Скоро: <a href="http://onreader.mdl.ru/UsingDocker/content/Ch04.html">Использование Docker</a></p>'+
'		<div id="gplusone">'+
