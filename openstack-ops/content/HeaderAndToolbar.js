...
'	<img src="/i/mdl-reg.jpg" style="border-style: none; top: 15%;" alt="Перевод Mdl&reg;" width="40" height="14" align="middle"/></a>'+
'	<a onclick="_gaq.push([\'_trackEvent\', \'Header\', \'logo\', \'click\', 1]);" target="_blank" href="http://docs.openstack.org/">'+
'	<img src="../common/images/openstack-logo.png" alt="Документация OpenStack" width="157" height="47"/></a>'+
''+
'	<h1>'+HeaderName+'</h1>'+
...
'	<div id="toolbar-left">'+
'		<p class="breadcrumbs"><a href="http://www.mdl.ru/Solutions/Put.htm?Nme=OpenStack">Облачные технологии</a>'+
'		<a href="http://support.mdl.ru/Implementing.Cloud.Storage.with.OpenStack.Swift/ToC.htm">Реализация облачного хранилища с OpenStack Swift</a>'+
'		<a href="http://docs.openstack.org/openstack-ops/content/index.html">Оригинал OSOG</a></p>'+
'		<a onclick="_gaq.push([\'_trackEvent\', \'Header\', \'pdfDownload\', \'click\', 1]);" alt="Загрузите pdf этого документа (англ.яз.)" class="pdficon" href="../openstack-ops-manual.pdf">'+
