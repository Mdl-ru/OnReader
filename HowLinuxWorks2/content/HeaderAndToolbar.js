...
'	<a onclick="_gaq.push([\'_trackEvent\', \'Header\', \'logo\', \'click\', 1]);" target="_blank" href="https://www.nostarch.com/howlinuxworks2">'+
'	<img src="../nsp225x225.jpg" alt="no strach press" width="45" height="45"/></a>'+
''+
'	<h1>'+HeaderName+'</h1>'+
...
'		<a href="http://www.piter.com/product_by_id/48311657">Профессиональный перевод</a>'+
'		(<a onclick="_gaq.push([\'_trackEvent\', \'Header\', \'pdfDownload\', \'click\', 1]);" alt="Загрузите pdf (Профессиональный перевод)" class="pdficon" href="http://www.piter.com/product_by_id/48311657">'+
'		<img src="../common/images/pdf.png"/></a>) &nbsp; '+
'		<a href="https://www.nostarch.com/howlinuxworks2">Купить оригинал</a></p>'+
'		<div id="gplusone">'+
